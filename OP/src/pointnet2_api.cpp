...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("get_iou_wrapper_fast", &get_iou_wrapper_fast, "get_iou_wrapper_fast");


    m.def("roi_maxpool_fp_wrapper_fast", &roi_maxpool_fp_wrapper_fast, "roi_maxpool_fp_wrapper_fast");
    m.def("roi_maxpool_bp_wrapper_fast", &roi_maxpool_bp_wrapper_fast, "roi_maxpool_bp_wrapper_fast");
